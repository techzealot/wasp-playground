/*
  ...
  - You are about to drop the column `desceription` on the `Task` table. All the data in the column will be lost.
...
INSERT INTO "new_Task" ("id", "isDone") SELECT "id", "isDone" FROM "Task";
DROP TABLE "Task";
